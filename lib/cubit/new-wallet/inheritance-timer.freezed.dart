    ...
    return _then(_value.copyWith(
      ...
      walletLabel: walletLabel == freezed
          ...
          : walletLabel // ignore: cast_nullable_to_non_nullable
              as String,
      errWalletLabel: errWalletLabel == freezed
          ? _value.errWalletLabel
          : errWalletLabel // ignore: cast_nullable_to_non_nullable
              as String,
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _InheritanceTimerState &&
            ...
            (identical(other.errWalletLabel, errWalletLabel) ||
                const DeepCollectionEquality()
                    .equals(other.errWalletLabel, errWalletLabel)) &&
